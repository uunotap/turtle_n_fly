...
class DroneController(Node):
    def __init__(self):
        ...
        # Publishing to the absolute topic the driver listens to
        self.cmd_vel_pub = self.create_publisher(Twist, '/mavic/cmd_vel', 10)

        # Subscribing to odometry to track altitude
