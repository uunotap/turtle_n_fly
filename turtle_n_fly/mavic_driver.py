...
class MavicDriver:
    ...
    def __cmd_vel_callback(self, twist):
        ...
        if twist.linear.z < -0.05:
            self.__landing_mode = True
        elif twist.linear.z > 0.05:
            self.__landing_mode = False
